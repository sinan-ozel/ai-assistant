...
## Built-in providers (agent_stem/default/providers/)

These ship with the system and require `MISTRAL_API_KEY`. They are available by name via `DEFAULT_PROVIDER`.

| File | Model | Notes |
|---|---|---|
| `default.yaml` | `mistral/mistral-large-2512` | Fallback when no custom providers exist |
| `vision.yaml` | `mistral/pixtral-12b-2409` | Multimodal — accepts image inputs |
| `coding.yaml` | `mistral/codestral-2501` | Optimised for code generation |
| `mistral-small.yaml` | `mistral/mistral-small-2501` | Smaller, faster |
| `mistral-7b.yaml` | `mistral/open-mistral-7b` | Open weights |
| `ministral-3b.yaml` | `mistral/ministral-3b-2512` | Very small |
| `ministral-14b.yaml` | `mistral/ministral-14b-2512` | Mid-size |
| `magistral-small.yaml` | `mistral/magistral-small-2509` | Reasoning model |
| `voxtral-mini.yaml` | `mistral/voxtral-mini-2507` | Audio |
| `voxtral-small.yaml` | `mistral/voxtral-small-2507` | Audio |

All built-in providers share the same structure:
